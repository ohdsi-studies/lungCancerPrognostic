...
WHERE (C.visit_start_date >= DATEFROMPARTS(2013, 1, 1) and C.visit_start_date <= DATEFROMPARTS(2013, 12, 31))
AND (YEAR(C.visit_start_date) - P.year_of_birth >= 55 and YEAR(C.visit_start_date) - P.year_of_birth <= 59)
