...
#'
#' @details
#' This function executes the LungCancerPoster Study.
#' 
  ...
  if(createValidationPackage){
      ...
      tryCatch({
        ...
        createValidationPackage(
          devPackageName = 'LungCancerPoster',
          devDatabaseName = cdmDatabaseName,
          analysisLocation = outputFolder,
          analysisIds = analysesToValidate,
          outputFolder = outputFolder,
          validationPackageName = 'LungCancerPrognosticValidation',
          description = 'validating models in LungCancerPrognostic',
          createdBy = 'anonymous',
